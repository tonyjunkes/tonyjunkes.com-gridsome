  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-blue-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><h2 class="text-xl">A Blog By Tony Junkes</h2></g-link>
          <g-link v-else to="/"><h2 class="text-xl">A Blog By Tony Junkes</h2></g-link>
        </div>
    ...
    <footer class="bg-blue-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>&copy; Copyright {{ new Date().getFullYear() }}. All rights reserved. &bull; By Tony Junkes</div>
          <div>
        ...
        <ul class="flex items-center">
          ...
          <li class="mr-8">
            <a href="https://github.com/tonyjunkes" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/tonyjunkes" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://stackoverflow.com/users/985709/tony-junkes" target="_blank" class="text-white hover:text-gray-400">
              <svg width="20px" height="20px" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="-135 22 32 38">
                  <g><polygon points="-108.5,56.2 -108.5,46.3 -105.2,46.3 -105.2,59.5 -135,59.5 -135,46.3 -131.7,46.3 -131.7,56.2       "/><path d="M-128,45.4l16.2,3.4l0.7-3.2l-16.2-3.4L-128,45.4z M-125.9,37.6l15,7l1.4-3l-15-7L-125.9,37.6z     M-121.7,30.2l12.7,10.6l2.1-2.5l-12.7-10.6L-121.7,30.2z M-113.5,22.4l-2.7,2l9.9,13.3l2.7-2L-113.5,22.4z M-128.4,52.9h16.6    v-3.3h-16.6V52.9z"/></g>
              </svg>
            </a>
          </li>

          <li class="mr-8">
            <a href="https://www.linkedin.com/in/tonyjunkes/" target="_blank" class="text-white hover:text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="20" height="20" viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" fill-rule="nonzero"/></svg>
            </a>
          </li>
